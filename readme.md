...
В 2017 году я начал полноценно изучать цикл разработки игр на базе игровых движков: сначала **Unreal Engine 4** из-за обилия видеоуроков на **YouTube**, а потом **Unity 3D** в виду того, что на моём рабочем месте я смог выдвинуть предложение о том, чтобы создать полноценную 3D-визуализацию на базе этого игрового движка.
