...
Я увлекался видеоиграми с самого детсва: моей первой игрой стала **PO'ed** на приставке **3DO**, на ПК же это были **Quake** и **Quake II**. Но всё же продолжительное время в детстве я проводил за **Денди** и практически всеми популярными на ней играми.

Разработка подобного меня заинтересовала в момент появления у меня дома ПК, когда я был в 4-ом классе: я играл во всё подряд, а годом позже начал делать карты для **Counter-Strike 1.6**, писать миссии для **Grand Theft Auto: San Andreas** и разрабатывать модификации для **Far Cry**.
